...
function loadRevision() {
    ...
    jQuery.ajax({
        ...
        success: function (meh) {
            ...
            tabView.prepend("<h2 class='propertypaneTitel'>Your deployment</h2>");
            tabView.show();
            ...
            if(totalProviders == 0){
                var html = '<div class="notice"><h3>No changes found</h3><p>Your current selection did not contain any changes, there is therefore no items in this deployment, and you can safely close this window</p>';
                    html += '<p><a href="' + window.location.href + '&force=true">Deploy anyway</a></p></div>';
