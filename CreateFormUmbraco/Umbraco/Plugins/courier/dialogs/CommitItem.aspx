...
<asp:Content ID="Content1" ContentPlaceHolderID="body" runat="server">
    ...
    <umb:Pane runat="server" ID="paneSelectItems" Text="Deploy items" Visible="false">
        ...
        <div style="border-top: 1px solid #ccc">
            ...
            <!-- Only needed when the item has children -->
             <asp:checkbox runat="server" ID="cbTransferAllChildren" cssclass="legacy-cb cbTransferAllChildren" Text="Yes, transfer all children as well" Checked="true"></asp:checkbox>
    ...
    <div id="buttons" class="umb-dialog-footer btn-toolbar umb-btn-toolbar">
        <asp:linkbutton CssClass="btn btn-link" onclick="transfer" runat="server" text="Go to advanced settings" />
        <asp:button runat="server" text="Deploy" cssclass="submitButton btn btn-primary" onclick="oneSteptransfer"/>
	</div>
    ...
    <umb:Pane runat="server" ID="paneSelectDefaults" Visible="false" Text="Should anything be overwritten?">
        ...
        <p>    
            ...
            <asp:dropdownlist runat="server" id="ddlDepth">
               <asp:ListItem Value="-1" selected="true">Selected items and all dependencies</asp:ListItem>
                <asp:ListItem Value="0">Selected items only</asp:ListItem>
                <asp:ListItem Value="1">Selected + 1 Dependency level</asp:ListItem>
                <asp:ListItem Value="2">Selected + 2 Dependency levels</asp:ListItem>
                <asp:ListItem Value="3">Selected + 3 Dependency levels</asp:ListItem>
            </asp:dropdownlist> 
         </p>
       </asp:placeholder>
        ...
        <br />
        <p>
            <asp:checkbox runat="server" id="cbOverWriteItems" CssClass="legacy-cb" text="Overwrite existing items"
                checked="true"></asp:checkbox>
        </p>
        <p>
            <asp:checkbox runat="server" id="cbOverWriteDeps" CssClass="legacy-cb" text="Overwrite existing dependencies"
                checked="true"></asp:checkbox>
        </p>
        <p>
            <asp:checkbox runat="server" id="cbOverWriteFiles" CssClass="legacy-cb" text="Overwrite existing files"
                checked="true"></asp:checkbox>
        </p>
    ...
    <div id="revisionTabview" style="display: none; height:auto; overflow:auto;">

    <asp:panel id="ph_revision" runat="server">
        <p class="umb-abstract">Revision items</p>    
        <div style="margin-top: 7px"  id="revision"></div>
    </asp:panel>

    <asp:panel id="ph_resources" runat="server">
        <p class="umb-abstract">Files</p> 
        <div style="margin-top: 7px" id="resources"></div>
    </asp:panel>
    ...
    <div id="buttons" class="umb-dialog-footer btn-toolbar umb-btn-toolbar">
	    <a class="btn btn-link" onclick="UmbClientMgr.closeModalWindow(); return false;"><%= umbraco.ui.Text("cancel") %></a>
	   <asp:button runat="server" text="Continue" cssclass="submitButton btn btn-primary" onclick="transfer"/>
    </div>
