             ...
             success: function (meh) {
                 ...
                 jQuery(meh.d).each(function (index, el) {
                     ...
                     if (el.TaskType != null) {
                         ...
                         html += "<div class='cou-progress'><div class='bar'><span style='width: " + el.Progress + "%;'></span></div><small>" + el.State + "</small></div>";
...
<div id="current" style="display: none;  overflow:auto; height: inherit;">
<h2 class="propertypaneTitel off">In-progress tasks</h2>
<ul class='taskmanager'></ul>
</div>

<div id="done" style="display: none;  overflow:auto; height: inherit;">
<h2 class="propertypaneTitel">No current tasks running</h2>
    <ul class='taskmanager'>
        <li>
               <p>
                    There are no current tasks running, you can close this window       
               </p>
        </li>
    </ul>
</div>
